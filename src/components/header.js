...
import { FlexHorizonCenter, FlexHorizonLeftCenter, FlexVerticalCenter } from "../common/style";
...
const DarkmodeOption = styled(FlexVerticalCenter)`
    padding: 5px;
    border-width: 2px;
    cursor: pointer;
    span {
    ...
    &:hover {
        ...
        border-style: solid;
        border-color: ${(props)=>props.theme === darkTheme ? "white" : "black"};
        border-radius: 10px;
    }
`
    ...
    return (
        <Wrapper>
            ...
            <OptionBar>
                { 
                darkmode ?
                <DarkmodeOption onClick={clickDarkmode}>
                    <SwitchDarkMode xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-sun" viewBox="0 0 16 16">
                ...
                :
                <DarkmodeOption onClick={clickDarkmode}>
                    <SwitchDarkMode xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" className="bi bi-cloud-moon-fill" viewBox="0 0 16 16">
